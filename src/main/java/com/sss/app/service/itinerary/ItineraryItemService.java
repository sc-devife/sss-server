...
public interface ItineraryItemService {
    ...
    TransportCancellationEmailPreviewDTO getTransportCancellationEmailPreview(UUID uid);
    SendEmailResponseDTO sendTransportCancellationEmail(UUID uid, String subject);
}
