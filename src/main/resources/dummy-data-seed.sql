...
BEGIN
    ...
    INSERT INTO leads (org_id, name, email, phone, destination, number_of_people, travel_date, duration_nights, budget, status, source_type, source_channel, origin_city, travel_type, is_priority, created_at, updated_at)
